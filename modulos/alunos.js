...
//Function para pegar todos os alunos
const getAlunos = () =>{
    let holdAlunos = [];
...
//Function para pegar um determinado aluno atraves do numero da matricula
const getAluno = (numMatricula = '') => {
    ...
    if(erro)
        ...
        return holdAlunoInfos
}

//Function para pegar as disciplinas de um aluno atraves do numero da matricula
const getAlunoDisciplinas = (numMatricula = '') => {
    let matricula = numMatricula;
    let holdInfosDisciplica = [];
    let erro = true;

    alunos.forEach(item => {
        item.curso.forEach(get => {
            get.disciplinas.forEach(infos => {
                if(item.matricula == matricula){
                    holdInfosDisciplica.push(
                        {
                            nome: infos.nome,
                            carga: infos.carga,
                            media: infos.media,
    ...
    if(erro)
        ...
        return holdInfosDisciplica;
}

//Function para pegar os alunos de tal disciplina 
const getAlunosByDisciplinas = (nomeDisciplina = '') => {
